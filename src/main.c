...
static Vector3 get_barecentric_coordinates(Vector3 v0, Vector3 v1, Vector3 v2,
                                           Vector3 p) {
...
static Vector3 barycentric_to_cartesian(Vector3 bc_pos, Vector3 v0, Vector3 v1,
                                        Vector3 v2) {
...
static void _draw_test_barycentric() {
  Vector3 p1 = {-1, 0, -1};
  Vector3 p2 = {-1, 0, 1};
  Vector3 p3 = {1, 0, 0};
