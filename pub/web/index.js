...
Module['FS_createPath']("/", "res", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/tex0.png", "start": 0, "end": 42066}], "remote_package_size": 42066});

  })();

// end include: /tmp/tmpl0k0z5_b.js
...
var ASM_CONSTS = {
  21896: () => { if (document.fullscreenElement) return 1; },  
 21942: () => { return document.getElementById('canvas').width; },  
 21994: () => { return parseInt(document.getElementById('canvas').style.width); },  
 22062: () => { document.exitFullscreen(); },  
 22089: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 22162: () => { if (document.fullscreenElement) return 1; },  
 22208: () => { return document.getElementById('canvas').width; },  
 22260: () => { return screen.width; },  
 22285: () => { document.exitFullscreen(); },  
 22312: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 22445: () => { if (document.fullscreenElement) return 1; },  
 22491: () => { return document.getElementById('canvas').width; },  
 22543: () => { return parseInt(document.getElementById('canvas').style.width); },  
 22611: () => { if (document.fullscreenElement) return 1; },  
 22657: () => { return document.getElementById('canvas').width; },  
 22709: () => { return screen.width; },  
 22734: () => { if (document.fullscreenElement) return 1; },  
 22780: () => { return document.getElementById('canvas').width; },  
 22832: () => { return screen.width; },  
 22857: () => { document.exitFullscreen(); },  
 22884: () => { if (document.fullscreenElement) return 1; },  
 22930: () => { return document.getElementById('canvas').width; },  
 22982: () => { return parseInt(document.getElementById('canvas').style.width); },  
 23050: () => { document.exitFullscreen(); },  
 23077: () => { return screen.width; },  
 23102: () => { return screen.height; },  
 23128: () => { return window.screenX; },  
 23155: () => { return window.screenY; },  
 23182: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 23235: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 23306: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 23363: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 23434: () => { if (document.fullscreenElement) return 1; },  
 23480: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 23527;
var ___stop_em_js = Module['___stop_em_js'] = 23600;
